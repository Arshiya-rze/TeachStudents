##### ==Web App چیست؟== (برنامه تحت وب)
بچه ها WebApp چیه کیا میتونن برام مثال بزنن؟
برنامه‌ایه که نیاز نیست نصبش کنیم، بلکه با مرورگر بازش می‌کنیم.

یه بار دیگه میخوام خیلی کوتاه و مختصر براتون Native/ Non-Native رو توضیح بدم

Native =>
برنامه‌ای که مخصوص یه سیستم‌عامل خاص ساخته شده، باهاش هماهنگه و مستقیم روی اون اجرا میشه.
مثال انسانی:
فرض کن کفش مخصوص خودت رو پوشیدی، دقیقاً اندازه پاته، توش راحتی، سریع راه میری.
Non-Native => 
برنامه‌ای که برای همه سیستم‌ها ساخته شده .
مثال انسانی:
فرض کن کفش یه نفر دیگه رو پوشیدی، اندازه نیست ولی باهاش راه میری. میشه راه رفت ولی نه به راحتی کفش خودت.

🚫 Web-App = Non-Native
یعنی روی کامپیوتر نصب نمیشه.

🌐 Web Browser چیه؟
مرورگر مثل Chrome, Firefox, Edge, Safari یک نرم‌افزار native هست که باهاش فایل‌هایی رو باز می‌کنیم.
...
در نتیجه :
در اپلیکیشن‌های Native، فایل روی خود سیستم نصب میشه.
...
برای مثال در همون انبار میاد میگه گوجه ها کجا باشن گوشت کجا باشه و ...
اطلاعات کاربران، رمزها، سفارش‌ها، عکس‌ها...
اون کسیه که اطلاعات رو ذخیره می‌کنه، نظم میده، و کاری می‌کنه که بتونیم بعداً راحت پیداشون کنیم.
📚 ابزارهای معمول:
SQL / MongoDB / PostgreSQL / Oracle
🧠 مثال ساده:
Database Developer
